...
class ConfigLoader:
    ...
    def _load_config(self) -> None:
        print("Load config file '{}'...".format(CONFIG_FILE_PATH))
    ...
    def _load_server_urls(self, config: configparser.ConfigParser) -> None:
        ...
        print("FLUX-server URLs loaded:")
        for key in flux_server_urls:
            print(key + ": " + flux_server_urls[key])
    ...
    def _load_section(self, config: configparser.ConfigParser, key: str) -> Optional[configparser.ConfigParser]:
        try:
            ...
            print("Error: config file has missing section '{}'. Using default values instead".format(key))
            return None
    ...
    def _load_int_value(self, section: Optional[configparser.ConfigParser], key: str, default_value: int) -> int:
        ...
        try:
            ...
            print("Error: config file has wrong format for value '{}'. Using default value {} instead".format(key,
                                                                                                              default_value))
