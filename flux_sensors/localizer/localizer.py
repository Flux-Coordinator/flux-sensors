...
if __name__ == "__main__":
    ...
    anchors = [DeviceCoordinates(0x6e4e, 1, Coordinates(-100, -100, 1150)),
               DeviceCoordinates(0x6964, 1, Coordinates(8450, -1200, 2150)),
               DeviceCoordinates(0x6e5f, 1, Coordinates(1250, -12000, 1150)),
               DeviceCoordinates(0x6e62, 1, Coordinates(7350, -11660, 1590))]
    ...
    r = Localizer(pozyx, osc_udp_client, anchors, algorithm, dimension, height, remote_id)
    r.setup()
    while True:
        r.loop()
